...
private val BlueLight = lightColorScheme(
    ...
    onSecondary = Color(0xFFFFFFFF),
    surface = Color(0xFFF0F4FF), // Blue tinted surface
...
private val BlueDark = darkColorScheme(
    ...
    surface = Color(0xFF0B141D), // Dark blue surface
...
private val GreenLight = lightColorScheme(
    ...
    onSecondary = Color(0xFFFFFFFF),
    surface = Color(0xFFF0FBF4), // Green tinted surface
...
private val GreenDark = darkColorScheme(
    ...
    surface = Color(0xFF0C150F), // Dark green surface
...
private val OrangeLight = lightColorScheme(
    ...
    onSecondary = Color(0xFFFFFFFF),
    surface = Color(0xFFFFF8F2), // Orange tinted surface
...
private val OrangeDark = darkColorScheme(
    ...
    surface = Color(0xFF17130B), // Dark orange surface
